...
func (d *DsDecoderV2) ReadDsClock() (uint, error) {
	return lib0.ReadVarUint(d.reader)
}

func (d *DsDecoderV2) ReadDsLen() (uint, error) {
	return lib0.ReadVarUint(d.reader)
}
...
func (d *UpdateDecoderV2) ReadClient() (uint, error) {
	client, err := lib0.ReadVarUint(d.reader)
	if err != nil {
		return 0, err
	}
...
func (d *UpdateDecoderV2) ReadInfo() (uint, error) {
...
func (d *UpdateDecoderV2) ReadTypeRef() (uint, error) {
...
func (d *UpdateDecoderV2) ReadLen() (uint, error) {
