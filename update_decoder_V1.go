...
func (d *DsDecoderV1) ReadDsClock() (uint, error) {
	return lib0.ReadVarUint(d.reader)
}

func (d *DsDecoderV1) ReadDsLen() (uint, error) {
	return lib0.ReadVarUint(d.reader)
}
...
func (d *UpdateDecoderV1) ReadClient() (uint, error) {
	client, err := lib0.ReadVarUint(d.reader)
	if err != nil {
		return 0, err
	}
...
func (d *UpdateDecoderV1) ReadInfo() (uint, error) {
...
func (d *UpdateDecoderV1) ReadTypeRef() (uint, error) {
...
func (d *UpdateDecoderV1) ReadLen() (uint, error) {
