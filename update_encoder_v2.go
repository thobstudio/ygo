...
func (e DsEncoderV2) WriteDsClock(num uint32) error {
	return lib0.WriteVarUint(e.writer, num)
}

func (e DsEncoderV2) WriteDsLen(num uint32) error {
	return lib0.WriteVarUint(e.writer, num)
}
...
func (e UpdateEncoderV2) WriteClient(client uint32) error {
...
func (e UpdateEncoderV2) WriteInfo(info uint32) error {
...
func (e UpdateEncoderV2) WriteTypeRef(ref uint32) error {
...
func (e UpdateEncoderV2) WriteLen(length uint32) error {
