...
func (e DsEncoderV1) WriteDsClock(num uint) error {
	return lib0.WriteVarUint(e.writer, num)
}

func (e DsEncoderV1) WriteDsLen(num uint) error {
	return lib0.WriteVarUint(e.writer, num)
}
...
func (e UpdateEncoderV1) WriteClient(client uint) error {
...
func (e UpdateEncoderV1) WriteInfo(info uint) error {
...
func (e UpdateEncoderV1) WriteTypeRef(ref uint) error {
...
func (e UpdateEncoderV1) WriteLen(length uint) error {
